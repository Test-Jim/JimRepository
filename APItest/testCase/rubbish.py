    ...
    while True:
        try:
            ...
            for index in range(len(text)):
                tmlist.append(driver.find_elements_by_id('com.jeeinc.save.worry:id/tv_brand_series')[index].text)
            tmlist = list(set(tmlist))
            # print tmlist
            for index in range(len(tmlist)):
                print '//android.widget.TextView[@text='+"'"+tmlist[index]+"'"+']'
                try:
                    driver.find_element_by_xpath('//android.widget.TextView[@text='+"'"+tmlist[index]+"'"+']').click()
                    # driver.implicitly_wait(20)
                    driver.find_element_by_id('com.jeeinc.save.worry:id/header_left_button').click()
                    # driver.implicitly_wait(20)
                except:
