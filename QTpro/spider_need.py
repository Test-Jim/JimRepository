...
def all():
    ...
    allUrl=['http://project.kuaiqiangche.cc/index.php?m=productplan&f=view&id=52',
            'http://project.kuaiqiangche.cc/index.php?m=productplan&f=view&id=50',
            'http://project.kuaiqiangche.cc/index.php?m=productplan&f=view&id=53',
            'http://project.kuaiqiangche.cc/index.php?m=productplan&f=view&id=41',
            'http://project.kuaiqiangche.cc/index.php?m=productplan&f=view&id=47',
            'http://project.kuaiqiangche.cc/index.php?m=productplan&f=view&id=49',
            'http://project.kuaiqiangche.cc/index.php?m=productplan&f=view&id=44']

    login=s.post(url=loginUrl,data=data,headers=headers)
    for index in allUrl:
        response=s.get(url=index,cookies = login.cookies,headers=headers)
